...
def create_makefile(control):
    ...
    def make_lines():
        ...
        lines.append('# generated by chart-03.py makefile')

        lines.append('%schart-03.data: chart-03.py' % working)
        lines.append('\t$(PYTHON) chart-03.py data')

        lines.append('chart-03.makefile: chart-03.py')
        lines.append('\t$(PYTHON) chart-03.py makefile')

        lines.append('%schart-03.txt: %schart-03.data chart-03.py' % (working,
                                                                      working))
        lines.append('\t$(PYTHON) chart-03.py txt')
        return lines
